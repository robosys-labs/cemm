...
__cemm_test_inventory__ = {
    ...
    'tests/test_r4_mutations_and_partitions.py::test_global_partition_successor_exposes_four_class_assignment_owner': {
        'activation_phase': 'R4',
    ...
    'tests/test_r4_mutations_and_partitions.py::test_r4_gap_episodes_cover_all_18_kinds': {
        'activation_phase': 'R4',
    ...
    'tests/test_r4_mutations_and_partitions.py::test_r4_gap_kinds_have_positive_and_near_miss': {
        'activation_phase': 'R4',
    ...
    'tests/test_r4_mutations_and_partitions.py::test_r4_hard_negatives_exist': {
        'activation_phase': 'R4',
    ...
    'tests/test_r4_mutations_and_partitions.py::test_r4_hard_negatives_mutate_one_dimension': {
        'activation_phase': 'R4',
    ...
    'tests/test_r4_mutations_and_partitions.py::test_r4_hard_negatives_retain_parent_lineage': {
        'activation_phase': 'R4',
    ...
    'tests/test_r4_mutations_and_partitions.py::test_r4_hard_negatives_have_verifier_error_labels': {
        'activation_phase': 'R4',
    ...
    'tests/test_r4_mutations_and_partitions.py::test_r4_hard_negatives_have_valid_labels': {
        'activation_phase': 'R4',
    ...
    'tests/test_r4_mutations_and_partitions.py::test_r4_hard_negatives_have_gap_kind': {
        'activation_phase': 'R4',
    ...
    'tests/test_r4_mutations_and_partitions.py::test_r4_proposer_miss_and_authority_gap_cases_exist': {
        'activation_phase': 'R4',
    ...
    'tests/test_r4_mutations_and_partitions.py::test_r4_hard_negatives_have_unique_refs': {
        'activation_phase': 'R4',
    ...
    'tests/test_r4_mutations_and_partitions.py::test_r4_hard_negatives_use_active_abi': {
        'activation_phase': 'R4',
