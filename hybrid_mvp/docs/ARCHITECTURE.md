...
A graph can contain up to 24 applications and depth 6. Application-valued roles use exact links. The MVP demonstrates speech attribution:
...
The embedded leave event is admitted under attributed epistemic scope and is excluded from direct world-event queries.
