...
| T03 | Authenticate the review manifest and source bundle | in_progress | CR-T03, CR-T03-HARDEN, CR-T03-TOPOLOGY, and CR-SOURCE-READINESS-GOV | TR-T03, TR-T03-GOVERNANCE, TR-INVENTORY-G0-T03, TR-INVENTORY-R4-T03, TR-T03-STATIC, and TR-SOURCE-READINESS-GOV | RC-T03 satisfied; RC-SOURCE-READINESS pending | AR-T03 satisfied | current 210-to-400 source reconstructs as 248 semantic, 112 explicit gap, 20 verification-rejection and 20 restart-diagnostic candidates; unpublished source ABIs and structural decisions require correction and exact human review |
| T04 | Check in the independently reviewed source package | pending | pending | pending | RC-SOURCE-READINESS and RC-SOURCE required | pending | SR1-SR5 corrections, exact source-readiness approval, diagnostic-only classifications and exact reviewed bytes |
...
| RC-SOURCE-READINESS | pending | SR1-SR5 implementation commits, deterministic source-only worksheets and one exact human approval covering the successor source universe, eight structural families, legacy conditional choice, restart diagnostics, designation/output/mutation truth, duplicate groups, purposes, holdouts, denominators and fixed minima |
