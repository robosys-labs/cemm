...
class HybridRuntime:
            ...
            if trace:
                trace_rows.append(
                    self._make_receipt(
                        ...
                        output_refs=(orientation.orientation_ref,),
                        status="ok",
                    )
                )
            phase_output_refs[SemanticPhase.ORIENT] = (orientation.orientation_ref,)
            ...
            if trace:
                trace_rows.append(
                    self._make_receipt(
                        ...
                        input_refs=(orientation.orientation_ref,),
    ...
    def _orient(
        ...
        return Orientation.create(
            ...
            revision_pin=pin,
            cache_key=stable_ref("orientation_cache", {"cycle": cycle_ref}),
        )
