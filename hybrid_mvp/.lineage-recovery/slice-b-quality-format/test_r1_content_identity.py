...
@pytest.mark.parametrize(
    ...
    (
        pytest.param(
            lambda data: {
                key: value for key, value in data.items() if key != "turn_ref"
            },
            id="missing",
        ),
        pytest.param(lambda data: {**data, "unknown": 1}, id="extra"),
        pytest.param(
            lambda data: {**data, "participants": tuple(data["participants"])},
            id="tuple-wire",
        ),
        pytest.param(
            lambda data: {**data, "budgets": MappingProxyType(data["budgets"])},
            id="mapping-wire",
        ),
        pytest.param(lambda data: {**data, "abi_version": True}, id="bool-abi"),
        pytest.param(
            lambda data: {**data, "scanned_atom_count": False}, id="bool-count"
        ),
...
def test_orientation_identity_covers_every_serialized_identity_field() -> None:
    ...
    variants = (
        _orientation(session_ref="session:two"),
        _orientation(turn_ref="turn:two"),
        _orientation(source_text="hello!"),
        _orientation(mode=SemanticMode.OBSERVE),
    ...
    assert (
        len({original.orientation_ref, *(row.orientation_ref for row in variants)})
        == len(variants) + 1
    )
...
def test_orientation_budgets_are_defensively_deep_frozen_and_bounded() -> None:
    ...
    for invalid in (
        ...
        {"tokens": -1},
        {"tokens": 2**63},
        {f"budget:{index}": index for index in range(65)},
    ):
        with pytest.raises((TypeError, ValueError)):
...
def test_orientation_from_dict_rejects_hostile_wire_list_before_hashing(
    monkeypatch,
) -> None:
...
def test_orientation_projection_and_decode_hash_complete_content_once(
    monkeypatch,
) -> None:
...
@pytest.mark.parametrize(
    ...
    (
        pytest.param(
            lambda data: {
                key: value for key, value in data.items() if key != "world_revision"
            },
            id="missing-field",
        ),
        ...
        pytest.param(
            lambda data: {**data, "authority_generation": 1}, id="generation-type"
        ),
...
def test_runtime_result_builder_requires_authentic_final_revision_pin() -> None:
    with pytest.raises(TypeError):
        HybridRuntime._build_result(
            "cycle:test",
            CycleStatus.PARTIAL,
            {},
            (),
...
def test_runtime_result_builder_retains_exact_final_revision_pin() -> None:
    pin = _pin()
    result = HybridRuntime._build_result(
        "cycle:test",
        CycleStatus.PARTIAL,
        {},
        (),
    ...
    assert result.final_revision_pin is pin
    assert result.final_revision_pin.revision_ref == pin.revision_ref


@pytest.mark.parametrize("owner_type", (BootstrapProposer, NeuralSwitchProposer))
def test_proposer_preserves_exact_orientation_revision_pin(
    owner_type: type[object],
) -> None:
    pin = _pin()
    owner = object.__new__(owner_type)
    object.__setattr__(
        owner, "_authority", SimpleNamespace(generation=pin.authority_generation)
    )

    assert owner._build_revision_pin(_orientation(revision_pin=pin)) is pin


@pytest.mark.parametrize("owner_type", (BootstrapProposer, NeuralSwitchProposer))
def test_proposer_rejects_orientation_authority_generation_mismatch(
    owner_type: type[object],
) -> None:
    owner = object.__new__(owner_type)
    object.__setattr__(owner, "_authority", SimpleNamespace(generation="authority:g2"))

    with pytest.raises(ValueError, match="authority generation"):
        owner._build_revision_pin(_orientation())
...
__cemm_test_inventory__ = {
    "tests/test_r1_content_identity.py::test_proposer_preserves_exact_orientation_revision_pin[BootstrapProposer]": {
        "activation_phase": "R1",
        "assertion_ref": "assertion:r1-slice-b-bootstrap-proposer-preserves-orientation-pin",
        "diagnostic_role": "owner",
        "introduced_by_task": "R1-Slice-B",
        "owner_ref": "orientation",
        "source_ast_sha256": "91acd576cf951ab535ac9bb72bbacce80675a4dc4a6477468fa6eb41c3323b6f",
    },
    "tests/test_r1_content_identity.py::test_proposer_preserves_exact_orientation_revision_pin[NeuralSwitchProposer]": {
        "activation_phase": "R1",
        "assertion_ref": "assertion:r1-slice-b-neural-proposer-preserves-orientation-pin",
        "diagnostic_role": "owner",
        "introduced_by_task": "R1-Slice-B",
        "owner_ref": "orientation",
        "source_ast_sha256": "91acd576cf951ab535ac9bb72bbacce80675a4dc4a6477468fa6eb41c3323b6f",
    },
    "tests/test_r1_content_identity.py::test_proposer_rejects_orientation_authority_generation_mismatch[BootstrapProposer]": {
        "activation_phase": "R1",
        "assertion_ref": "assertion:r1-slice-b-bootstrap-proposer-rejects-generation-drift",
        "diagnostic_role": "owner",
        "introduced_by_task": "R1-Slice-B",
        "owner_ref": "orientation",
        "source_ast_sha256": "82f9dfa995ee073bef4b8002d8a2f0af666006e437685fc69aed4b2a6e68a8e9",
    },
    "tests/test_r1_content_identity.py::test_proposer_rejects_orientation_authority_generation_mismatch[NeuralSwitchProposer]": {
        "activation_phase": "R1",
        "assertion_ref": "assertion:r1-slice-b-neural-proposer-rejects-generation-drift",
        "diagnostic_role": "owner",
        "introduced_by_task": "R1-Slice-B",
        "owner_ref": "orientation",
        "source_ast_sha256": "82f9dfa995ee073bef4b8002d8a2f0af666006e437685fc69aed4b2a6e68a8e9",
    },
    "tests/test_r1_content_identity.py::test_orientation_projection_and_decode_hash_complete_content_once": {
        "activation_phase": "R1",
    ...
    "tests/test_r1_content_identity.py::test_orientation_abi1_round_trip_is_strict_and_omits_cache_metadata": {
        "activation_phase": "R1",
    ...
    "tests/test_r1_content_identity.py::test_orientation_identity_covers_every_serialized_identity_field": {
        "activation_phase": "R1",
    ...
    "tests/test_r1_content_identity.py::test_orientation_cache_key_is_transient_and_identity_independent": {
        "activation_phase": "R1",
    ...
    "tests/test_r1_content_identity.py::test_orientation_budgets_are_defensively_deep_frozen_and_bounded": {
        "activation_phase": "R1",
    ...
    "tests/test_r1_content_identity.py::test_orientation_create_rejects_hostile_content_before_hashing": {
        "activation_phase": "R1",
    ...
    "tests/test_r1_content_identity.py::test_orientation_from_dict_rejects_hostile_wire_list_before_hashing": {
        "activation_phase": "R1",
    ...
    "tests/test_r1_content_identity.py::test_orientation_has_no_lineage_or_meaning_defaults": {
        "activation_phase": "R1",
    ...
    "tests/test_r1_content_identity.py::test_orientation_abi1_rejects_noncanonical_wire_payload[missing]": {
        "activation_phase": "R1",
        "assertion_ref": "assertion:r1-slice-b-orientation-rejects-missing",
        "diagnostic_role": "owner",
        "introduced_by_task": "R1-Slice-B",
        "owner_ref": "orientation",
        "source_ast_sha256": "b7a9d36e72388301ebe49609df8e0aa6d68a69c691c917e85974d16eaf425514",
    },
    "tests/test_r1_content_identity.py::test_orientation_abi1_rejects_noncanonical_wire_payload[extra]": {
        "activation_phase": "R1",
    ...
    "tests/test_r1_content_identity.py::test_orientation_abi1_rejects_noncanonical_wire_payload[tuple-wire]": {
        "activation_phase": "R1",
    ...
    "tests/test_r1_content_identity.py::test_orientation_abi1_rejects_noncanonical_wire_payload[mapping-wire]": {
        "activation_phase": "R1",
    ...
    "tests/test_r1_content_identity.py::test_orientation_abi1_rejects_noncanonical_wire_payload[bool-abi]": {
        "activation_phase": "R1",
    ...
    "tests/test_r1_content_identity.py::test_orientation_abi1_rejects_noncanonical_wire_payload[bool-count]": {
        "activation_phase": "R1",
    ...
    "tests/test_r1_content_identity.py::test_orientation_abi1_rejects_noncanonical_wire_payload[enum-wire]": {
        "activation_phase": "R1",
    ...
    "tests/test_r1_content_identity.py::test_orientation_abi1_rejects_noncanonical_wire_payload[pin-wire]": {
        "activation_phase": "R1",
    ...
    "tests/test_r1_content_identity.py::test_orientation_abi1_rejects_noncanonical_wire_payload[forged-ref]": {
        "activation_phase": "R1",
    ...
    "tests/test_r1_content_identity.py::test_revision_pin_from_dict_rejects_oversized_dict_before_key_validation": {
        "activation_phase": "R1",
    ...
    "tests/test_r1_content_identity.py::test_revision_pin_from_dict_rejects_nonexact_string_keys": {
        "activation_phase": "R1",
    ...
    "tests/test_r1_content_identity.py::test_revision_pin_wire_contract_and_inclusive_boundaries": {
        "activation_phase": "R1",
    ...
    "tests/test_r1_content_identity.py::test_runtime_result_builder_retains_exact_final_revision_pin": {
        "activation_phase": "R1",
        "assertion_ref": "assertion:r1-runtime-result-retains-exact-final-pin",
        "diagnostic_role": "owner",
        "introduced_by_task": "R1-Slice-A",
        "owner_ref": "content-identity",
        "source_ast_sha256": "0c68cdacb3b8237a43d91bb4104c381d0e7a061b9e5d629791cd4e932509b17b",
    },
    "tests/test_r1_content_identity.py::test_revision_pin_constructor_rejects_invalid_exact_content": {
        "activation_phase": "R1",
    ...
    "tests/test_r1_content_identity.py::test_revision_pin_from_dict_requires_exact_canonical_payload": {
        "activation_phase": "R1",
    ...
    "tests/test_r1_content_identity.py::test_cycle_result_requires_authentic_final_revision_pin": {
        "activation_phase": "R1",
    ...
    "tests/test_r1_content_identity.py::test_runtime_result_builder_requires_authentic_final_revision_pin": {
        "activation_phase": "R1",
        "assertion_ref": "assertion:r1-runtime-result-requires-final-pin",
        "diagnostic_role": "owner",
        "introduced_by_task": "R1-Slice-A",
        "owner_ref": "content-identity",
        "source_ast_sha256": "2e680550de022efe507366289f3729d16d75148626a4719f2c85f930975edad8",
    },
