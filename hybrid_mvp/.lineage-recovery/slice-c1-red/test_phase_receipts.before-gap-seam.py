...
def _c1_artifacts():
    ...
    gap = _C1GapReceipt(
        gap_ref="gap:111111111111111111111111",
...
def test_c1_cycle_result_roundtrip_and_constructor_forgery_checks_verify_gap_state():
    ...
    with _c1_pytest.raises(ValueError, match="trace"):
        _c1_replace(
            result,
            trace=(
                _c1_replace(
...
def test_c1_cycle_identity_and_pin_chain_are_exact():
    ...
    variants = (
        ...
        _c1_finalize(
            capture_trace=False,
            gap_receipt=_c1_replace(
                gap, gap_ref="gap:222222222222222222222222"
            ),
        ),
    )
    ...
    with _c1_pytest.raises(ValueError, match="pin chain"):
        _c1_finalize(
            capture_trace=False,
            phase_material=(
                materials[0],
