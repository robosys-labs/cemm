"""Durable learning patch types.

The core loop may build rich temporary UOL graphs, but durable memory updates
must cross this explicit boundary. A GraphPatch is a candidate mutation, not an
executed write.
"""
...
class PatchOperation:
    """One proposed durable-memory operation."""
...
@dataclass
class GraphPatch:
    """Only legal durable learning mutation input."""
