...
_FRAME_TO_INTENT: dict[str, str] = {
    ...
    "user_name_query": "user_profile_query",
    "user_age_query": "user_profile_query",
    "assert_evaluation": "statement",
    "state_preference": "statement",
    "low_competence": "frustration_signal",
    "useless_assistant": "frustration_signal",
    "high_quality": "assistant_evaluation",
...
_PORT_CONSTRAINTS: dict[str, list[str]] = {
    ...
    "user_profile_query": ["subject", "attribute"],
