...
def goal_candidate_from_document(value: Mapping[str, Any]) -> GoalCandidateRecord:
    ...
    return GoalCandidateRecord(
        ...
        authorization_refs=tuple(map(str, d.get("authorization_refs", ()))),
        authorization_pins=tuple(_pin(dict(x)) for x in d.get("authorization_pins", ())),
        prerequisite_frontier_refs=tuple(map(str, d.get("prerequisite_frontier_refs", ()))),
