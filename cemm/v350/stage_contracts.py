...
_CONTRACTS = (
    _c(CoreStage.ORIENT_AND_PIN_SEMANTIC_BRAIN, (),
       ("authority_snapshot", "read_generation", "kernel_semantic_abi", "participant_frame", "context_stack", "runtime_budgets"),
    ...
    _c(CoreStage.COMPILE_CANDIDATES_TO_CSIR, ("evidence_lattice", "grounding_candidates", "referent_projections", "authority_snapshot", "kernel_semantic_abi"),
    ...
    _c(CoreStage.RUN_RECURRENT_MEANING_DYNAMICS, ("csir_candidates", "authority_snapshot"),
    ...
    _c(CoreStage.STABILIZE_SEMANTIC_ATTRACTORS, ("activation_graph", "activation_trace"),
    ...
    _c(CoreStage.BUILD_DISCOURSE_PROPOSITION_EVENT_AND_QUERY_STRUCTURES, ("semantic_attractors",),
    ...
    _c(CoreStage.PLACE_EPISTEMIC_CONTEXT_AND_ASSIMILATE_WORLD_BELIEF, ("claims", "events", "evidence_envelopes"),
    ...
    _c(CoreStage.QUERY_AND_EXPLAIN_FROM_GROUNDED_WORLD_MODEL, ("queries", "epistemic_placement"),
    ...
    _c(CoreStage.COMMIT_AUTHORIZED_KNOWLEDGE_STATE_AND_LEARNING_ARTIFACTS,
       ...
       ("commit_receipts", "committed_read_generation"), optional=("learning_candidate_work", "learning_frontiers"), persistence=PersistenceClass.DURABLE_COMMIT,
